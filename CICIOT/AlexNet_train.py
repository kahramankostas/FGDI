...
torch.save(pre_last, 'pre_val_label/pre_last_AlexNet.pt')
torch.save(val_last, 'pre_val_label/val_last_AlexNet.pt')
# 迭代次数列表作为横坐标
...
plot_accuracy(iterations, train_accurate_list, val_accurate_list, save_path='AlexNet_accuracy_plot_npy.png')
plot_f1_score(iterations, f1_list, save_path='AlexNet_f1_score_plot_npy.png')
