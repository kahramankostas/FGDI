...
train_dataset = CustomDataset("features/train_npy_noARP_noDHCP",transform=transform)
...
validate_dataset = CustomDataset("features/val_npy_noARP_noDHCP",transform=transform)
...
torch.save(pre_last, 'pre_val_label/pre_last_VggNet.pt')
torch.save(val_last, 'pre_val_label/val_last_VggNet.pt')
...
plot_accuracy(iterations, train_accurate_list, val_accurate_list, save_path='VggNet_accuracy_plot_npy.png')
plot_f1_score(iterations, f1_list, save_path='VggNet_f1_score_plot_npy.png')
