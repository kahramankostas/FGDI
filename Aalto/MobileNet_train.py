...
from MobileNet_model_v2 import MobileNetV2
...
torch.save(pre_last, 'pre_val_label/pre_last_MobileNet.pt')
torch.save(val_last, 'pre_val_label/val_last_MobileNet.pt')
# 迭代次数列表作为横坐标
...
plot_accuracy(iterations, train_accurate_list, val_accurate_list, save_path='MobileNet_accuracy_plot_npy.png')
plot_f1_score(iterations, f1_list, save_path='MobileNet_f1_score_plot_npy.png')
